...
<body>
  ...
  <div class="main">
    ...
    <section class="g-join-method g-box lazy" data-original="${match.submissionIntroduceImage}">
      <h2 class="hide">报名方式</h2>
      <article class="con">
        <div class="join-method">
          ${match.submissionIntroduce}
      </article>
    </section>
    <div class="join-form">
        ...
        <section class="join-box">
          ...
          <article class="bd">
            ...
            <div class="form-item">
              ...
              <div class="form-input__wrap">
                  <input type="email" class="ui-input" id="email" placeholder="请填写邮箱" autocomplete="off">
              </div>
            </div>
            <div class="form-item">
              <div class="form-label">联系方式</div>
              <div class="form-input__wrap">
                  <input type="tel" class="ui-input" id="tel" placeholder="请填写手机号码" autocomplete="off">
              </div>
            </div>
            <div class="form-item">
                ...
                <div class="upload-wrap" id="uploadWrap">
                  <div class="upload-item">
                    <div class="place" id="fullViewSpace">
                      ...
                      <div class="work-img-thumb hide">
                        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" class="thumb" id="fullViewThumbImg" width="180" height="100">
                  ...
                  <div class="upload-item">
                    <div class="place" id="nearbyView1Space">
                      ...
                      <div class="work-img-thumb hide">
                        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" class="thumb" id="nearbyView1ThumbImg" width="180" height="100">
                  ...
                  <div class="upload-item">
                    <div class="place" id="nearbyView2Space">
                      ...
                      <div class="work-img-thumb hide">
                        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" class="thumb" id="nearbyView2ThumbImg" width="180" height="100">
                  ...
                  <div class="upload-item">
                    <div class="place" id="nearbyView3Space">
                      ...
                      <div class="work-img-thumb hide">
                        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" class="thumb" id="nearbyView3ThumbImg" width="180" height="100">
  ...
  <![endif]-->
  <script src="http://heby-test.mini1.cn/statics/jzds/luluui/peak/js/common/ui/Select.js"></script>
  <script src="http://heby-test.mini1.cn/statics/jzds/luluui/peak/js/common/ui/Placeholder.js"></script>
  ...
  <script src="http://heby-test.mini1.cn/statics/jzds/app/pc/js/app.join.js"></script>
</body>
